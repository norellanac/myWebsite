            ...
            <div>
                <section className="ftco-section services-section bg-light ftco-no-pb">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-8 col-md-8 d-flex align-self-stretch ftco-animate">
                                <div className="media block-6 services d-flex align-items-start">
                                    <div className="icon d-flex align-items-center justify-content-center">
                                        <span className="flaticon">
                                            <img src=".../img/norellanac1.png" className="rounded"
                                    ...
                                    <div className="media-body pl-4">
                                        ...
                                        <p>
                                            <span className="ml-4"> <i className="fas fa-mobile-alt"> </i> Celular: <a
                                                href="tel:50233120413">+502
                                                33120413</a> </span> <br />
                                            <span className="ml-4"> <i className="fas fa-envelope-open-text"> </i> Correo: <a
                                                href="mailto:alexis_oc@yahoo.es">alexis_oc@yahoo.es</a> </span> <br />
                                            <span className="ml-4"> <i className="fas fa-envelope-open-text"> </i> Dirección: <a
                                                href="https://goo.gl/maps/tzokv8QcD8RgRRms9">San José Pinula, Guatemala</a>
                                            </span> <br />
                                            <span className="ml-4"> <i className="fab fa-chrome"> </i> Sitio Web: <a
                            ...
                            <div className="col-lg-4 col-md-4 d-flex  ftco-animate justify-content-center">
                                <div className="media block-6 services d-flex text-center">
                                    <div className="media-body ">
                                        <img src="oldCv/img/umg.png" className="" style={{height: "100px;"}} />
                                        <h3 className="" style={{fontSize: "25px;"}}>Educación</h3>
                    ...
                    <div className="container">
                        <div className="row justify-content-center mb-5 pb-3">
                            <div className="col-md-7 text-center heading-section ftco-animate">
                                <h2 className="mb-4 text-light">Habilidades</h2>
                            </div>
                        </div>
                        <div className="row">
                    ...
                    <div className="container-fluid">
                        <div className="row justify-content-center pt-5">
                            <div className="col-md-7 text-center">
                                <h2 className="mb-4 text-light">Empresas que formaron mi experiencia</h2>
                                <p></p>
                            </div>
                        </div>
